...
// Defaults tuned to match baseetStudioWebSIte production init (hour-14 day anchor).
// Live site still passes colors at runtime via vanta-init.reference.js — these are
// fallbacks for Toolcraft preview when options are omitted.
Effect.prototype.defaultOptions = {
  backgroundColor: 0xffffff,
  skyColor: 0x78acd7,
  cloudColor: 0xf1e5eb,
  cloudShadowColor: 0x4b60af,
  sunColor: 0xff9919,
