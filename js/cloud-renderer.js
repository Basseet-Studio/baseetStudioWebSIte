...
var CloudRenderer = class {
  ...
  async init() {
    try {
      ...
      this.material = new ShaderMaterial({
        ...
        transparent: true
        // Enable alpha blending for compositing clouds over background
      });
  ...
  animate() {
    ...
    const elapsedTime = (currentTime - this.startTime) / 1e3;
  ...
  resume() {
    if (!this.isAnimating) {
      if (this.startTime !== null && this.material && this.material.uniforms && this.material.uniforms.uTime) {
        ...
        this.startTime = performance.now() - pausedTime * 1e3;
      }
      this.isAnimating = true;
      this.animate();
    }
