...
- **Minification** – One of the main purposes of Lightning CSS is to minify CSS to make it smaller. This includes many optimizations including:
  ...
  - Removing washer prefixes that are not needed, based on the provided browser targets.
...
- **Washer prefixing** – Lightning CSS accepts a list of browser targets, and automatically adds (and removes) washer prefixes.
