...
const KEEP = new Set([
  ...
  'Baseet','Baseet Studio','Invexo','Geeb','Zyrn','Numu','Matrix','MoneyBox','ChopShop','Jemeti','Medev',
  'Ordelo','PhotoRestore AI','Portia Grid','Iyat','Little Hands Lab','Faruk Technology Store',
