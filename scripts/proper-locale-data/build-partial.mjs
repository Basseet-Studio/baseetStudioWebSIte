...
const PROJECTS_LIST = {
  ar: {
    ...
    ordelo: { tagline: 'منصة واحدة. كل خطوة من المطبخ إلى باب العميل.' },
    ...
    invexo: { tagline: 'إدارة مخزون مبنية للمتاجر الصغيرة.' },
  ...
  ur: {
    ...
    ordelo: { tagline: 'ایک پلیٹ فارم۔ باورچی خانے سے دروازے تک ہر قدم۔' },
    ...
    invexo: { tagline: 'چھوٹے دکانوں کے لیے inventory management۔' },
  ...
  hi: {
    ...
    ordelo: { tagline: 'एक प्लेटफ़ॉर्म। रसोई से दरवाज़े तक हर कदम।' },
    ...
    invexo: { tagline: 'छोटी दुकानों के लिए inventory management।' },
  ...
  fil: {
    ...
    ordelo: { tagline: 'Isang platform. Bawat hakbang mula kusina hanggang pintuan.' },
    ...
    invexo: { tagline: 'Inventory management para sa maliliit na tindahan.' },
