 ...
 */
export function resolveIcon(faClass: string | undefined | null): { name: string; variant?: 'regular' | 'bold' | 'fill' } {
  ...
  const tryName = FA_TO_PHOSPHOR[`fas ${baseClass}`] || FA_TO_PHOSPHOR[`fab ${baseClass}`];
