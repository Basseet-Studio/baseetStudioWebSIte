...
const BRIGHTNESS = 0.2 // default; legal docs use LEGAL_BRIGHTNESS below
const COLOR_1 = '#F5F749' // Geeb amber
const COLOR_2 = '#FBFFF1' // Geeb deep amber
const COLOR_3 = '#ffffff' // Geeb cream
